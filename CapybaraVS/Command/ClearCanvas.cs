...
namespace CapyCSS.Command
{
    ...
    /// カレントのスクリプトをクリアします。
    /// </summary>
    internal class ClearCanvas
        : IMenuCommand
    {
        public static IMenuCommand Create()
        {
            return new ClearCanvas();
        }
        ...
        public static string _Name => "Clear Script Cnavas";
        public Func<string> HintText => () => $"{_Name}(Ctrl+Shift+N)";
        ...
        public void Execute(object parameter)
        {
            ...
            if (self != null)
            {
                self.CurrentScriptCanvas?.ClearWorkCanvasWithConfirmation();
