...
namespace CapyCSS.Command
{
        ...
        : IMenuCommand
    {
        ...
        public static string _Name => "ReDo";
        public Func<string> HintText => () => $"{_Name}(Ctrl+Y)";
        ...
        public bool CanExecute(object parameter)
        {
            ...
            var current = CommandCanvasList.Instance.CurrentScriptCanvas;
            return current != null && current.CanReDo && self.IsScriptRunningMask;
        }
        ...
        public void Execute(object parameter)
        {
            ...
            if (self != null)
            {
                var current = self.CurrentScriptCanvas;
                current?.ReDo();
                current?.CloseCommandWindow();
            }
        }
    }
}
